...
public final class JSplash extends JWindow {
	...
	public JSplash(URL url, boolean progress, boolean messages,
			boolean percent, String versionString, Font versionStringFont,
			Color versionStringColor, Color progressbarColor) {
	...
	public JSplash(URL url, boolean progress, boolean messages,
			boolean percent, String versionString, Color progressbarColor) {
		this.m_progress.setForeground(progressbarColor);
	...
	public JSplash(URL url, boolean progress, boolean messages,
			boolean percent, String versionString) {
		this.m_progressBar = progress;
		this.m_progressBarMessages = messages;
		this.m_progressBarPercent = percent;
